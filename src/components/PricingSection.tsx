        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              {
                name: '기본형 (OnePage)',
                features: ['- 메인 비주얼 1, 메인 5개파트', '- PC, Mobile 대응'],
                price: '₩900,000',
                extra: '₩360,000(1년 기준)',
                discount: '-₩360,000',
                total: '₩900,000',
              ...
              {
                name: '프리미엄Pro',
                features: ['- 메인 1, 서브 10페이지', '- 반응형(PC & WEB)', '- 관리자페이지 및 고급 기능 포함'],
                price: '₩4,500,000',
                extra: '₩360,000(1년 기준)',
                discount: '-₩360,000',
                total: '₩4,500,000',
              ...
              {
                name: '구독형 (Subscription)',
                features: [
                  '- 초기 제작비 없음(고객 페이지 전용)',
                  '- 월 구독료로 유지·보수·수정 포함',
                  '- PC, Mobile 대응 + 콘텐츠 수정 지원',
              ...
              {
                name: '구독형 프리미엄(Subscription)',
                features: [
                  '- 초기 제작비 없음 (고객페이지+관리자페이지)',
                  '- 월 구독료로 유지·보수·수정 포함',
                  '- PC, Mobile 대응 + 콘텐츠 수정 지원',
                  '- QR코드 제공 + 운영 가이드 포함',
                ],
                ...
                <div className={`group relative border rounded-xl p-6 overflow-hidden transition duration-300 ${idx === 3 ? 'bg-red-50' : 'bg-white'} shadow hover:shadow-xl`}>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="text-left text-base space-y-1 mb-4">
                      ...
                      <p>첫 해 할인: <b className="text-red-500">{plan.discount}</b></p>
